...
//go:generate minimock -i github.com/unhandled-exception/sophiadb/internal/pkg/indexplanner.sPlan -o mock_splan_test.go -n SPlanMock -p indexplanner
...
func (mmOpen *mSPlanMockOpen) Optional() *mSPlanMockOpen {
...
// Times sets number of times sPlan.Open should be invoked
func (mmOpen *mSPlanMockOpen) Times(n uint64) *mSPlanMockOpen {
	if n == 0 {
		mmOpen.mock.t.Fatalf("Times of SPlanMock.Open mock can not be zero")
	}
...
func (mmOpen *mSPlanMockOpen) invocationsDone() bool {
...
func (m *SPlanMock) MinimockOpenInspect() {
	...
	if m.OpenMock.defaultExpectation != nil && afterOpenCounter < 1 {
		m.t.Errorf("Expected call to SPlanMock.Open at\n%s", m.OpenMock.defaultExpectation.returnOrigin)
	}
	...
	if !m.OpenMock.invocationsDone() && afterOpenCounter > 0 {
		m.t.Errorf("Expected %d calls to SPlanMock.Open at\n%s but found %d calls",
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmSchema *mSPlanMockSchema) Optional() *mSPlanMockSchema {
...
// Times sets number of times sPlan.Schema should be invoked
func (mmSchema *mSPlanMockSchema) Times(n uint64) *mSPlanMockSchema {
	if n == 0 {
		mmSchema.mock.t.Fatalf("Times of SPlanMock.Schema mock can not be zero")
	}
...
func (mmSchema *mSPlanMockSchema) invocationsDone() bool {
...
func (m *SPlanMock) MinimockSchemaInspect() {
	...
	if m.SchemaMock.defaultExpectation != nil && afterSchemaCounter < 1 {
		m.t.Errorf("Expected call to SPlanMock.Schema at\n%s", m.SchemaMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.SchemaMock.invocationsDone() && afterSchemaCounter > 0 {
		m.t.Errorf("Expected %d calls to SPlanMock.Schema at\n%s but found %d calls",
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmString *mSPlanMockString) Optional() *mSPlanMockString {
...
// Times sets number of times sPlan.String should be invoked
func (mmString *mSPlanMockString) Times(n uint64) *mSPlanMockString {
	if n == 0 {
		mmString.mock.t.Fatalf("Times of SPlanMock.String mock can not be zero")
	}
...
func (mmString *mSPlanMockString) invocationsDone() bool {
...
func (m *SPlanMock) MinimockStringInspect() {
	...
	if m.StringMock.defaultExpectation != nil && afterStringCounter < 1 {
		m.t.Errorf("Expected call to SPlanMock.String at\n%s", m.StringMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.StringMock.invocationsDone() && afterStringCounter > 0 {
		m.t.Errorf("Expected %d calls to SPlanMock.String at\n%s but found %d calls",
