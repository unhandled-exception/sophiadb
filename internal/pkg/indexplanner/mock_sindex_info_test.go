...
func (m *SIndexInfoMock) MinimockBlocksAccessedInspect() {
	...
	if m.BlocksAccessedMock.defaultExpectation != nil && afterBlocksAccessedCounter < 1 {
		m.t.Errorf("Expected call to SIndexInfoMock.BlocksAccessed at\n%s", m.BlocksAccessedMock.defaultExpectation.returnOrigin)
	}
	...
	if !m.BlocksAccessedMock.invocationsDone() && afterBlocksAccessedCounter > 0 {
		m.t.Errorf("Expected %d calls to SIndexInfoMock.BlocksAccessed at\n%s but found %d calls",
...
type SIndexInfoMockDistinctValuesExpectation struct {
	...
	expectationOrigins SIndexInfoMockDistinctValuesExpectationOrigins
...
// SIndexInfoMockDistinctValuesOrigins contains origins of expectations of the sIndexInfo.DistinctValues
type SIndexInfoMockDistinctValuesExpectationOrigins struct {
	origin          string
...
func (mmDistinctValues *mSIndexInfoMockDistinctValues) When(fieldName string) *SIndexInfoMockDistinctValuesExpectation {
	...
	expectation := &SIndexInfoMockDistinctValuesExpectation{
		...
		expectationOrigins: SIndexInfoMockDistinctValuesExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	...
	if mmDistinctValues.DistinctValuesMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fieldName != nil && !minimock.Equal(*mm_want_ptrs.fieldName, mm_got.fieldName) {
				mmDistinctValues.t.Errorf("SIndexInfoMock.DistinctValues got unexpected parameter fieldName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			mmDistinctValues.t.Errorf("SIndexInfoMock.DistinctValues got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *SIndexInfoMock) MinimockDistinctValuesInspect() {
	for _, e := range m.DistinctValuesMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to SIndexInfoMock.DistinctValues at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.DistinctValuesMock.invocationsDone() && afterDistinctValuesCounter > 0 {
		m.t.Errorf("Expected %d calls to SIndexInfoMock.DistinctValues at\n%s but found %d calls",
...
func (m *SIndexInfoMock) MinimockOpenInspect() {
	...
	if m.OpenMock.defaultExpectation != nil && afterOpenCounter < 1 {
		m.t.Errorf("Expected call to SIndexInfoMock.Open at\n%s", m.OpenMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.OpenMock.invocationsDone() && afterOpenCounter > 0 {
		m.t.Errorf("Expected %d calls to SIndexInfoMock.Open at\n%s but found %d calls",
...
func (m *SIndexInfoMock) MinimockRecordsInspect() {
	...
	if m.RecordsMock.defaultExpectation != nil && afterRecordsCounter < 1 {
		m.t.Errorf("Expected call to SIndexInfoMock.Records at\n%s", m.RecordsMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.RecordsMock.invocationsDone() && afterRecordsCounter > 0 {
		m.t.Errorf("Expected %d calls to SIndexInfoMock.Records at\n%s but found %d calls",
...
func (m *SIndexInfoMock) MinimockStringInspect() {
	...
	if m.StringMock.defaultExpectation != nil && afterStringCounter < 1 {
		m.t.Errorf("Expected call to SIndexInfoMock.String at\n%s", m.StringMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.StringMock.invocationsDone() && afterStringCounter > 0 {
		m.t.Errorf("Expected %d calls to SIndexInfoMock.String at\n%s but found %d calls",
