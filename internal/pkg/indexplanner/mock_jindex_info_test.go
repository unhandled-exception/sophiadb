...
func (m *JIndexInfoMock) MinimockBlocksAccessedInspect() {
	...
	if m.BlocksAccessedMock.defaultExpectation != nil && afterBlocksAccessedCounter < 1 {
		m.t.Errorf("Expected call to JIndexInfoMock.BlocksAccessed at\n%s", m.BlocksAccessedMock.defaultExpectation.returnOrigin)
	}
	...
	if !m.BlocksAccessedMock.invocationsDone() && afterBlocksAccessedCounter > 0 {
		m.t.Errorf("Expected %d calls to JIndexInfoMock.BlocksAccessed at\n%s but found %d calls",
...
func (m *JIndexInfoMock) MinimockOpenInspect() {
	...
	if m.OpenMock.defaultExpectation != nil && afterOpenCounter < 1 {
		m.t.Errorf("Expected call to JIndexInfoMock.Open at\n%s", m.OpenMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.OpenMock.invocationsDone() && afterOpenCounter > 0 {
		m.t.Errorf("Expected %d calls to JIndexInfoMock.Open at\n%s but found %d calls",
...
func (m *JIndexInfoMock) MinimockRecordsInspect() {
	...
	if m.RecordsMock.defaultExpectation != nil && afterRecordsCounter < 1 {
		m.t.Errorf("Expected call to JIndexInfoMock.Records at\n%s", m.RecordsMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.RecordsMock.invocationsDone() && afterRecordsCounter > 0 {
		m.t.Errorf("Expected %d calls to JIndexInfoMock.Records at\n%s but found %d calls",
...
func (m *JIndexInfoMock) MinimockStringInspect() {
	...
	if m.StringMock.defaultExpectation != nil && afterStringCounter < 1 {
		m.t.Errorf("Expected call to JIndexInfoMock.String at\n%s", m.StringMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.StringMock.invocationsDone() && afterStringCounter > 0 {
		m.t.Errorf("Expected %d calls to JIndexInfoMock.String at\n%s but found %d calls",
