...
type JPlanMock struct {
	...
	funcBlocksAccessedOrigin    string
	...
	funcDistinctValuesOrigin    string
...
func (mmBlocksAccessed *mJPlanMockBlocksAccessed) Return(i1 int64) *JPlanMock {
	...
	mmBlocksAccessed.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmBlocksAccessed *mJPlanMockBlocksAccessed) Set(f func() (i1 int64)) *JPlanMock {
	...
	mmBlocksAccessed.mock.funcBlocksAccessedOrigin = minimock.CallerInfo(1)
	return mmBlocksAccessed.mock
}
...
func (mmBlocksAccessed *mJPlanMockBlocksAccessed) Times(n uint64) *mJPlanMockBlocksAccessed {
	...
	mmBlocksAccessed.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmBlocksAccessed
}
...
func (m *JPlanMock) MinimockBlocksAccessedInspect() {
	...
	if m.BlocksAccessedMock.defaultExpectation != nil && afterBlocksAccessedCounter < 1 {
		m.t.Errorf("Expected call to JPlanMock.BlocksAccessed at\n%s", m.BlocksAccessedMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	if m.funcBlocksAccessed != nil && afterBlocksAccessedCounter < 1 {
		m.t.Errorf("Expected call to JPlanMock.BlocksAccessed at\n%s", m.funcBlocksAccessedOrigin)
	}

	if !m.BlocksAccessedMock.invocationsDone() && afterBlocksAccessedCounter > 0 {
		m.t.Errorf("Expected %d calls to JPlanMock.BlocksAccessed at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.BlocksAccessedMock.expectedInvocations), m.BlocksAccessedMock.expectedInvocationsOrigin, afterBlocksAccessedCounter)
	}
}
...
type JPlanMockDistinctValuesExpectation struct {
	...
	expectationOrigins JPlanMockDistinctValuesExpectationOrigins
...
// JPlanMockDistinctValuesOrigins contains origins of expectations of the jPlan.DistinctValues
type JPlanMockDistinctValuesExpectationOrigins struct {
	origin          string
...
func (mmDistinctValues *mJPlanMockDistinctValues) Expect(fieldName string) *mJPlanMockDistinctValues {
	...
	mmDistinctValues.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmDistinctValues *mJPlanMockDistinctValues) ExpectFieldNameParam1(fieldName string) *mJPlanMockDistinctValues {
	...
	mmDistinctValues.defaultExpectation.expectationOrigins.originFieldName = minimock.CallerInfo(1)
...
func (mmDistinctValues *mJPlanMockDistinctValues) Return(i1 int64, b1 bool) *JPlanMock {
	...
	mmDistinctValues.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmDistinctValues *mJPlanMockDistinctValues) Set(f func(fieldName string) (i1 int64, b1 bool)) *JPlanMock {
	...
	mmDistinctValues.mock.funcDistinctValuesOrigin = minimock.CallerInfo(1)
	return mmDistinctValues.mock
}
...
func (mmDistinctValues *mJPlanMockDistinctValues) When(fieldName string) *JPlanMockDistinctValuesExpectation {
	...
	expectation := &JPlanMockDistinctValuesExpectation{
		...
		expectationOrigins: JPlanMockDistinctValuesExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmDistinctValues *mJPlanMockDistinctValues) Times(n uint64) *mJPlanMockDistinctValues {
	...
	mmDistinctValues.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmDistinctValues
}
	...
	if mmDistinctValues.DistinctValuesMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fieldName != nil && !minimock.Equal(*mm_want_ptrs.fieldName, mm_got.fieldName) {
				mmDistinctValues.t.Errorf("JPlanMock.DistinctValues got unexpected parameter fieldName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDistinctValues.DistinctValuesMock.defaultExpectation.expectationOrigins.originFieldName, *mm_want_ptrs.fieldName, mm_got.fieldName, minimock.Diff(*mm_want_ptrs.fieldName, mm_got.fieldName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDistinctValues.t.Errorf("JPlanMock.DistinctValues got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmDistinctValues.DistinctValuesMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *JPlanMock) MinimockDistinctValuesInspect() {
	for _, e := range m.DistinctValuesMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to JPlanMock.DistinctValues at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.DistinctValuesMock.defaultExpectation != nil && afterDistinctValuesCounter < 1 {
		if m.DistinctValuesMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to JPlanMock.DistinctValues at\n%s", m.DistinctValuesMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to JPlanMock.DistinctValues at\n%s with params: %#v", m.DistinctValuesMock.defaultExpectation.expectationOrigins.origin, *m.DistinctValuesMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcDistinctValues != nil && afterDistinctValuesCounter < 1 {
		m.t.Errorf("Expected call to JPlanMock.DistinctValues at\n%s", m.funcDistinctValuesOrigin)
	}

	if !m.DistinctValuesMock.invocationsDone() && afterDistinctValuesCounter > 0 {
		m.t.Errorf("Expected %d calls to JPlanMock.DistinctValues at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.DistinctValuesMock.expectedInvocations), m.DistinctValuesMock.expectedInvocationsOrigin, afterDistinctValuesCounter)
	}
}
...
func (m *JPlanMock) MinimockOpenInspect() {
	...
	if m.OpenMock.defaultExpectation != nil && afterOpenCounter < 1 {
		m.t.Errorf("Expected call to JPlanMock.Open at\n%s", m.OpenMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.OpenMock.invocationsDone() && afterOpenCounter > 0 {
		m.t.Errorf("Expected %d calls to JPlanMock.Open at\n%s but found %d calls",
...
func (mmRecords *mJPlanMockRecords) Return(i1 int64) *JPlanMock {
	...
	mmRecords.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmRecords *mJPlanMockRecords) Set(f func() (i1 int64)) *JPlanMock {
	...
	mmRecords.mock.funcRecordsOrigin = minimock.CallerInfo(1)
	return mmRecords.mock
}
...
func (mmRecords *mJPlanMockRecords) Times(n uint64) *mJPlanMockRecords {
	...
	mmRecords.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmRecords
}
...
func (m *JPlanMock) MinimockRecordsInspect() {
	...
	if m.RecordsMock.defaultExpectation != nil && afterRecordsCounter < 1 {
		m.t.Errorf("Expected call to JPlanMock.Records at\n%s", m.RecordsMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	if m.funcRecords != nil && afterRecordsCounter < 1 {
		m.t.Errorf("Expected call to JPlanMock.Records at\n%s", m.funcRecordsOrigin)
	}

	if !m.RecordsMock.invocationsDone() && afterRecordsCounter > 0 {
		m.t.Errorf("Expected %d calls to JPlanMock.Records at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.RecordsMock.expectedInvocations), m.RecordsMock.expectedInvocationsOrigin, afterRecordsCounter)
	}
}
...
func (m *JPlanMock) MinimockSchemaInspect() {
	...
	if m.SchemaMock.defaultExpectation != nil && afterSchemaCounter < 1 {
		m.t.Errorf("Expected call to JPlanMock.Schema at\n%s", m.SchemaMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.SchemaMock.invocationsDone() && afterSchemaCounter > 0 {
		m.t.Errorf("Expected %d calls to JPlanMock.Schema at\n%s but found %d calls",
...
func (m *JPlanMock) MinimockStringInspect() {
	...
	if m.StringMock.defaultExpectation != nil && afterStringCounter < 1 {
		m.t.Errorf("Expected call to JPlanMock.String at\n%s", m.StringMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.StringMock.invocationsDone() && afterStringCounter > 0 {
		m.t.Errorf("Expected %d calls to JPlanMock.String at\n%s but found %d calls",
