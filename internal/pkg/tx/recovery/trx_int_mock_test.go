...
type TrxIntMockPinExpectation struct {
	...
	expectationOrigins TrxIntMockPinExpectationOrigins
...
// TrxIntMockPinOrigins contains origins of expectations of the trxInt.Pin
type TrxIntMockPinExpectationOrigins struct {
	origin      string
	originBlock string
}
...
func (mmPin *mTrxIntMockPin) Expect(block types.Block) *mTrxIntMockPin {
	...
	mmPin.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmPin *mTrxIntMockPin) ExpectBlockParam1(block types.Block) *mTrxIntMockPin {
	...
	mmPin.defaultExpectation.expectationOrigins.originBlock = minimock.CallerInfo(1)
...
func (mmPin *mTrxIntMockPin) Return(err error) *TrxIntMock {
	...
	mmPin.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmPin.mock
}
...
func (mmPin *mTrxIntMockPin) Set(f func(block types.Block) (err error)) *TrxIntMock {
	...
	mmPin.mock.funcPinOrigin = minimock.CallerInfo(1)
	return mmPin.mock
}
...
func (mmPin *mTrxIntMockPin) When(block types.Block) *TrxIntMockPinExpectation {
	...
	expectation := &TrxIntMockPinExpectation{
		...
		expectationOrigins: TrxIntMockPinExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmPin *mTrxIntMockPin) Times(n uint64) *mTrxIntMockPin {
	...
	mmPin.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmPin
}
	...
	if mmPin.PinMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.block != nil && !minimock.Equal(*mm_want_ptrs.block, mm_got.block) {
				mmPin.t.Errorf("TrxIntMock.Pin got unexpected parameter block, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmPin.PinMock.defaultExpectation.expectationOrigins.originBlock, *mm_want_ptrs.block, mm_got.block, minimock.Diff(*mm_want_ptrs.block, mm_got.block))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmPin.t.Errorf("TrxIntMock.Pin got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmPin.PinMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TrxIntMock) MinimockPinInspect() {
	for _, e := range m.PinMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TrxIntMock.Pin at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.PinMock.defaultExpectation != nil && afterPinCounter < 1 {
		if m.PinMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to TrxIntMock.Pin at\n%s", m.PinMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to TrxIntMock.Pin at\n%s with params: %#v", m.PinMock.defaultExpectation.expectationOrigins.origin, *m.PinMock.defaultExpectation.params)
		}
	}
	...
	if !m.PinMock.invocationsDone() && afterPinCounter > 0 {
		m.t.Errorf("Expected %d calls to TrxIntMock.Pin at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.PinMock.expectedInvocations), m.PinMock.expectedInvocationsOrigin, afterPinCounter)
	}
}
...
type TrxIntMockSetInt64Expectation struct {
	...
	expectationOrigins TrxIntMockSetInt64ExpectationOrigins
...
// TrxIntMockSetInt64Origins contains origins of expectations of the trxInt.SetInt64
type TrxIntMockSetInt64ExpectationOrigins struct {
	origin        string
	originBlock   string
	originOffset  string
	originValue   string
	originOkToLog string
}
...
func (mmSetInt64 *mTrxIntMockSetInt64) Expect(block types.Block, offset uint32, value int64, okToLog bool) *mTrxIntMockSetInt64 {
	...
	mmSetInt64.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmSetInt64 *mTrxIntMockSetInt64) ExpectBlockParam1(block types.Block) *mTrxIntMockSetInt64 {
	...
	mmSetInt64.defaultExpectation.expectationOrigins.originBlock = minimock.CallerInfo(1)
...
func (mmSetInt64 *mTrxIntMockSetInt64) ExpectOffsetParam2(offset uint32) *mTrxIntMockSetInt64 {
	...
	mmSetInt64.defaultExpectation.expectationOrigins.originOffset = minimock.CallerInfo(1)
...
func (mmSetInt64 *mTrxIntMockSetInt64) ExpectValueParam3(value int64) *mTrxIntMockSetInt64 {
	...
	mmSetInt64.defaultExpectation.expectationOrigins.originValue = minimock.CallerInfo(1)
...
func (mmSetInt64 *mTrxIntMockSetInt64) ExpectOkToLogParam4(okToLog bool) *mTrxIntMockSetInt64 {
	...
	mmSetInt64.defaultExpectation.expectationOrigins.originOkToLog = minimock.CallerInfo(1)
...
func (mmSetInt64 *mTrxIntMockSetInt64) Return(err error) *TrxIntMock {
	...
	mmSetInt64.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmSetInt64 *mTrxIntMockSetInt64) Set(f func(block types.Block, offset uint32, value int64, okToLog bool) (err error)) *TrxIntMock {
	...
	mmSetInt64.mock.funcSetInt64Origin = minimock.CallerInfo(1)
	return mmSetInt64.mock
}
...
func (mmSetInt64 *mTrxIntMockSetInt64) When(block types.Block, offset uint32, value int64, okToLog bool) *TrxIntMockSetInt64Expectation {
	...
	expectation := &TrxIntMockSetInt64Expectation{
		...
		expectationOrigins: TrxIntMockSetInt64ExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmSetInt64 *mTrxIntMockSetInt64) Times(n uint64) *mTrxIntMockSetInt64 {
	...
	mmSetInt64.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmSetInt64
}
...
func (mmSetInt64 *TrxIntMock) SetInt64(block types.Block, offset uint32, value int64, okToLog bool) (err error) {
	...
	if mmSetInt64.SetInt64Mock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.block != nil && !minimock.Equal(*mm_want_ptrs.block, mm_got.block) {
				mmSetInt64.t.Errorf("TrxIntMock.SetInt64 got unexpected parameter block, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetInt64.SetInt64Mock.defaultExpectation.expectationOrigins.originBlock, *mm_want_ptrs.block, mm_got.block, minimock.Diff(*mm_want_ptrs.block, mm_got.block))
			}

			if mm_want_ptrs.offset != nil && !minimock.Equal(*mm_want_ptrs.offset, mm_got.offset) {
				mmSetInt64.t.Errorf("TrxIntMock.SetInt64 got unexpected parameter offset, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetInt64.SetInt64Mock.defaultExpectation.expectationOrigins.originOffset, *mm_want_ptrs.offset, mm_got.offset, minimock.Diff(*mm_want_ptrs.offset, mm_got.offset))
			}

			if mm_want_ptrs.value != nil && !minimock.Equal(*mm_want_ptrs.value, mm_got.value) {
				mmSetInt64.t.Errorf("TrxIntMock.SetInt64 got unexpected parameter value, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetInt64.SetInt64Mock.defaultExpectation.expectationOrigins.originValue, *mm_want_ptrs.value, mm_got.value, minimock.Diff(*mm_want_ptrs.value, mm_got.value))
			}

			if mm_want_ptrs.okToLog != nil && !minimock.Equal(*mm_want_ptrs.okToLog, mm_got.okToLog) {
				mmSetInt64.t.Errorf("TrxIntMock.SetInt64 got unexpected parameter okToLog, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetInt64.SetInt64Mock.defaultExpectation.expectationOrigins.originOkToLog, *mm_want_ptrs.okToLog, mm_got.okToLog, minimock.Diff(*mm_want_ptrs.okToLog, mm_got.okToLog))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSetInt64.t.Errorf("TrxIntMock.SetInt64 got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmSetInt64.SetInt64Mock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TrxIntMock) MinimockSetInt64Inspect() {
	for _, e := range m.SetInt64Mock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TrxIntMock.SetInt64 at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.SetInt64Mock.defaultExpectation != nil && afterSetInt64Counter < 1 {
		if m.SetInt64Mock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to TrxIntMock.SetInt64 at\n%s", m.SetInt64Mock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to TrxIntMock.SetInt64 at\n%s with params: %#v", m.SetInt64Mock.defaultExpectation.expectationOrigins.origin, *m.SetInt64Mock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcSetInt64 != nil && afterSetInt64Counter < 1 {
		m.t.Errorf("Expected call to TrxIntMock.SetInt64 at\n%s", m.funcSetInt64Origin)
	}

	if !m.SetInt64Mock.invocationsDone() && afterSetInt64Counter > 0 {
		m.t.Errorf("Expected %d calls to TrxIntMock.SetInt64 at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.SetInt64Mock.expectedInvocations), m.SetInt64Mock.expectedInvocationsOrigin, afterSetInt64Counter)
	}
}
...
type TrxIntMockSetInt8Expectation struct {
	...
	expectationOrigins TrxIntMockSetInt8ExpectationOrigins
...
// TrxIntMockSetInt8Origins contains origins of expectations of the trxInt.SetInt8
type TrxIntMockSetInt8ExpectationOrigins struct {
	origin        string
	originBlock   string
	originOffset  string
	originValue   string
...
func (mmSetInt8 *mTrxIntMockSetInt8) Expect(block types.Block, offset uint32, value int8, okToLog bool) *mTrxIntMockSetInt8 {
	...
	mmSetInt8.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmSetInt8 *mTrxIntMockSetInt8) ExpectBlockParam1(block types.Block) *mTrxIntMockSetInt8 {
	...
	mmSetInt8.defaultExpectation.expectationOrigins.originBlock = minimock.CallerInfo(1)
...
func (mmSetInt8 *mTrxIntMockSetInt8) ExpectOffsetParam2(offset uint32) *mTrxIntMockSetInt8 {
	...
	mmSetInt8.defaultExpectation.expectationOrigins.originOffset = minimock.CallerInfo(1)
...
func (mmSetInt8 *mTrxIntMockSetInt8) ExpectValueParam3(value int8) *mTrxIntMockSetInt8 {
	...
	mmSetInt8.defaultExpectation.expectationOrigins.originValue = minimock.CallerInfo(1)
...
func (mmSetInt8 *mTrxIntMockSetInt8) ExpectOkToLogParam4(okToLog bool) *mTrxIntMockSetInt8 {
	...
	mmSetInt8.defaultExpectation.expectationOrigins.originOkToLog = minimock.CallerInfo(1)
...
func (mmSetInt8 *mTrxIntMockSetInt8) Return(err error) *TrxIntMock {
	...
	mmSetInt8.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmSetInt8 *mTrxIntMockSetInt8) Set(f func(block types.Block, offset uint32, value int8, okToLog bool) (err error)) *TrxIntMock {
	...
	mmSetInt8.mock.funcSetInt8Origin = minimock.CallerInfo(1)
	return mmSetInt8.mock
}
...
func (mmSetInt8 *mTrxIntMockSetInt8) When(block types.Block, offset uint32, value int8, okToLog bool) *TrxIntMockSetInt8Expectation {
	...
	expectation := &TrxIntMockSetInt8Expectation{
		...
		expectationOrigins: TrxIntMockSetInt8ExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmSetInt8 *mTrxIntMockSetInt8) Times(n uint64) *mTrxIntMockSetInt8 {
	...
	mmSetInt8.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmSetInt8
}
...
func (mmSetInt8 *TrxIntMock) SetInt8(block types.Block, offset uint32, value int8, okToLog bool) (err error) {
	...
	if mmSetInt8.SetInt8Mock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.block != nil && !minimock.Equal(*mm_want_ptrs.block, mm_got.block) {
				mmSetInt8.t.Errorf("TrxIntMock.SetInt8 got unexpected parameter block, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetInt8.SetInt8Mock.defaultExpectation.expectationOrigins.originBlock, *mm_want_ptrs.block, mm_got.block, minimock.Diff(*mm_want_ptrs.block, mm_got.block))
			}

			if mm_want_ptrs.offset != nil && !minimock.Equal(*mm_want_ptrs.offset, mm_got.offset) {
				mmSetInt8.t.Errorf("TrxIntMock.SetInt8 got unexpected parameter offset, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetInt8.SetInt8Mock.defaultExpectation.expectationOrigins.originOffset, *mm_want_ptrs.offset, mm_got.offset, minimock.Diff(*mm_want_ptrs.offset, mm_got.offset))
			}

			if mm_want_ptrs.value != nil && !minimock.Equal(*mm_want_ptrs.value, mm_got.value) {
				mmSetInt8.t.Errorf("TrxIntMock.SetInt8 got unexpected parameter value, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetInt8.SetInt8Mock.defaultExpectation.expectationOrigins.originValue, *mm_want_ptrs.value, mm_got.value, minimock.Diff(*mm_want_ptrs.value, mm_got.value))
			}

			if mm_want_ptrs.okToLog != nil && !minimock.Equal(*mm_want_ptrs.okToLog, mm_got.okToLog) {
				mmSetInt8.t.Errorf("TrxIntMock.SetInt8 got unexpected parameter okToLog, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetInt8.SetInt8Mock.defaultExpectation.expectationOrigins.originOkToLog, *mm_want_ptrs.okToLog, mm_got.okToLog, minimock.Diff(*mm_want_ptrs.okToLog, mm_got.okToLog))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSetInt8.t.Errorf("TrxIntMock.SetInt8 got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmSetInt8.SetInt8Mock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TrxIntMock) MinimockSetInt8Inspect() {
	for _, e := range m.SetInt8Mock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TrxIntMock.SetInt8 at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.SetInt8Mock.defaultExpectation != nil && afterSetInt8Counter < 1 {
		if m.SetInt8Mock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to TrxIntMock.SetInt8 at\n%s", m.SetInt8Mock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to TrxIntMock.SetInt8 at\n%s with params: %#v", m.SetInt8Mock.defaultExpectation.expectationOrigins.origin, *m.SetInt8Mock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcSetInt8 != nil && afterSetInt8Counter < 1 {
		m.t.Errorf("Expected call to TrxIntMock.SetInt8 at\n%s", m.funcSetInt8Origin)
	}

	if !m.SetInt8Mock.invocationsDone() && afterSetInt8Counter > 0 {
		m.t.Errorf("Expected %d calls to TrxIntMock.SetInt8 at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.SetInt8Mock.expectedInvocations), m.SetInt8Mock.expectedInvocationsOrigin, afterSetInt8Counter)
	}
}
...
type TrxIntMockSetStringExpectation struct {
	...
	expectationOrigins TrxIntMockSetStringExpectationOrigins
...
// TrxIntMockSetStringOrigins contains origins of expectations of the trxInt.SetString
type TrxIntMockSetStringExpectationOrigins struct {
	origin        string
	originBlock   string
	originOffset  string
	originValue   string
...
func (mmSetString *mTrxIntMockSetString) Expect(block types.Block, offset uint32, value string, okToLog bool) *mTrxIntMockSetString {
	...
	mmSetString.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmSetString *mTrxIntMockSetString) ExpectBlockParam1(block types.Block) *mTrxIntMockSetString {
	...
	mmSetString.defaultExpectation.expectationOrigins.originBlock = minimock.CallerInfo(1)
...
func (mmSetString *mTrxIntMockSetString) ExpectOffsetParam2(offset uint32) *mTrxIntMockSetString {
	...
	mmSetString.defaultExpectation.expectationOrigins.originOffset = minimock.CallerInfo(1)
...
func (mmSetString *mTrxIntMockSetString) ExpectValueParam3(value string) *mTrxIntMockSetString {
	...
	mmSetString.defaultExpectation.expectationOrigins.originValue = minimock.CallerInfo(1)
...
func (mmSetString *mTrxIntMockSetString) ExpectOkToLogParam4(okToLog bool) *mTrxIntMockSetString {
	...
	mmSetString.defaultExpectation.expectationOrigins.originOkToLog = minimock.CallerInfo(1)
...
func (mmSetString *mTrxIntMockSetString) Return(err error) *TrxIntMock {
	...
	mmSetString.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmSetString *mTrxIntMockSetString) Set(f func(block types.Block, offset uint32, value string, okToLog bool) (err error)) *TrxIntMock {
	...
	mmSetString.mock.funcSetStringOrigin = minimock.CallerInfo(1)
	return mmSetString.mock
}
...
func (mmSetString *mTrxIntMockSetString) When(block types.Block, offset uint32, value string, okToLog bool) *TrxIntMockSetStringExpectation {
	...
	expectation := &TrxIntMockSetStringExpectation{
		...
		expectationOrigins: TrxIntMockSetStringExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmSetString *mTrxIntMockSetString) Times(n uint64) *mTrxIntMockSetString {
	...
	mmSetString.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmSetString
}
...
func (mmSetString *TrxIntMock) SetString(block types.Block, offset uint32, value string, okToLog bool) (err error) {
	...
	if mmSetString.SetStringMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.block != nil && !minimock.Equal(*mm_want_ptrs.block, mm_got.block) {
				mmSetString.t.Errorf("TrxIntMock.SetString got unexpected parameter block, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetString.SetStringMock.defaultExpectation.expectationOrigins.originBlock, *mm_want_ptrs.block, mm_got.block, minimock.Diff(*mm_want_ptrs.block, mm_got.block))
			}

			if mm_want_ptrs.offset != nil && !minimock.Equal(*mm_want_ptrs.offset, mm_got.offset) {
				mmSetString.t.Errorf("TrxIntMock.SetString got unexpected parameter offset, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetString.SetStringMock.defaultExpectation.expectationOrigins.originOffset, *mm_want_ptrs.offset, mm_got.offset, minimock.Diff(*mm_want_ptrs.offset, mm_got.offset))
			}

			if mm_want_ptrs.value != nil && !minimock.Equal(*mm_want_ptrs.value, mm_got.value) {
				mmSetString.t.Errorf("TrxIntMock.SetString got unexpected parameter value, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetString.SetStringMock.defaultExpectation.expectationOrigins.originValue, *mm_want_ptrs.value, mm_got.value, minimock.Diff(*mm_want_ptrs.value, mm_got.value))
			}

			if mm_want_ptrs.okToLog != nil && !minimock.Equal(*mm_want_ptrs.okToLog, mm_got.okToLog) {
				mmSetString.t.Errorf("TrxIntMock.SetString got unexpected parameter okToLog, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetString.SetStringMock.defaultExpectation.expectationOrigins.originOkToLog, *mm_want_ptrs.okToLog, mm_got.okToLog, minimock.Diff(*mm_want_ptrs.okToLog, mm_got.okToLog))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSetString.t.Errorf("TrxIntMock.SetString got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmSetString.SetStringMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TrxIntMock) MinimockSetStringInspect() {
	for _, e := range m.SetStringMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TrxIntMock.SetString at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.SetStringMock.defaultExpectation != nil && afterSetStringCounter < 1 {
		if m.SetStringMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to TrxIntMock.SetString at\n%s", m.SetStringMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to TrxIntMock.SetString at\n%s with params: %#v", m.SetStringMock.defaultExpectation.expectationOrigins.origin, *m.SetStringMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcSetString != nil && afterSetStringCounter < 1 {
		m.t.Errorf("Expected call to TrxIntMock.SetString at\n%s", m.funcSetStringOrigin)
	}

	if !m.SetStringMock.invocationsDone() && afterSetStringCounter > 0 {
		m.t.Errorf("Expected %d calls to TrxIntMock.SetString at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.SetStringMock.expectedInvocations), m.SetStringMock.expectedInvocationsOrigin, afterSetStringCounter)
	}
}
...
func (mmTXNum *mTrxIntMockTXNum) Return(t1 types.TRX) *TrxIntMock {
	...
	mmTXNum.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmTXNum.mock
}
...
func (mmTXNum *mTrxIntMockTXNum) Set(f func() (t1 types.TRX)) *TrxIntMock {
	...
	mmTXNum.mock.funcTXNumOrigin = minimock.CallerInfo(1)
	return mmTXNum.mock
}
...
func (mmTXNum *mTrxIntMockTXNum) Times(n uint64) *mTrxIntMockTXNum {
	...
	mmTXNum.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmTXNum
}
...
func (m *TrxIntMock) MinimockTXNumInspect() {
	...
	if m.TXNumMock.defaultExpectation != nil && afterTXNumCounter < 1 {
		m.t.Errorf("Expected call to TrxIntMock.TXNum at\n%s", m.TXNumMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.TXNumMock.invocationsDone() && afterTXNumCounter > 0 {
		m.t.Errorf("Expected %d calls to TrxIntMock.TXNum at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.TXNumMock.expectedInvocations), m.TXNumMock.expectedInvocationsOrigin, afterTXNumCounter)
	}
}
...
type TrxIntMockUnpinExpectation struct {
	...
	expectationOrigins TrxIntMockUnpinExpectationOrigins
...
// TrxIntMockUnpinOrigins contains origins of expectations of the trxInt.Unpin
type TrxIntMockUnpinExpectationOrigins struct {
	origin      string
	originBlock string
}
...
func (mmUnpin *mTrxIntMockUnpin) Expect(block types.Block) *mTrxIntMockUnpin {
	...
	mmUnpin.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmUnpin *mTrxIntMockUnpin) ExpectBlockParam1(block types.Block) *mTrxIntMockUnpin {
	...
	mmUnpin.defaultExpectation.expectationOrigins.originBlock = minimock.CallerInfo(1)
...
func (mmUnpin *mTrxIntMockUnpin) Return() *TrxIntMock {
	...
	mmUnpin.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmUnpin.mock
}
...
func (mmUnpin *mTrxIntMockUnpin) Set(f func(block types.Block)) *TrxIntMock {
	...
	mmUnpin.mock.funcUnpinOrigin = minimock.CallerInfo(1)
	return mmUnpin.mock
}
...
func (mmUnpin *mTrxIntMockUnpin) When(block types.Block) *TrxIntMockUnpinExpectation {
	...
	expectation := &TrxIntMockUnpinExpectation{
		...
		expectationOrigins: TrxIntMockUnpinExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (e *TrxIntMockUnpinExpectation) Then() *TrxIntMock {
	return e.mock
}
...
func (mmUnpin *mTrxIntMockUnpin) Times(n uint64) *mTrxIntMockUnpin {
	...
	mmUnpin.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmUnpin
}
...
func (mmUnpin *TrxIntMock) Unpin(block types.Block) {
	...
	if mmUnpin.UnpinMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.block != nil && !minimock.Equal(*mm_want_ptrs.block, mm_got.block) {
				mmUnpin.t.Errorf("TrxIntMock.Unpin got unexpected parameter block, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmUnpin.UnpinMock.defaultExpectation.expectationOrigins.originBlock, *mm_want_ptrs.block, mm_got.block, minimock.Diff(*mm_want_ptrs.block, mm_got.block))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUnpin.t.Errorf("TrxIntMock.Unpin got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmUnpin.UnpinMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TrxIntMock) MinimockUnpinInspect() {
	for _, e := range m.UnpinMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TrxIntMock.Unpin at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.UnpinMock.defaultExpectation != nil && afterUnpinCounter < 1 {
		if m.UnpinMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to TrxIntMock.Unpin at\n%s", m.UnpinMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to TrxIntMock.Unpin at\n%s with params: %#v", m.UnpinMock.defaultExpectation.expectationOrigins.origin, *m.UnpinMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.UnpinMock.invocationsDone() && afterUnpinCounter > 0 {
		m.t.Errorf("Expected %d calls to TrxIntMock.Unpin at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.UnpinMock.expectedInvocations), m.UnpinMock.expectedInvocationsOrigin, afterUnpinCounter)
	}
}
