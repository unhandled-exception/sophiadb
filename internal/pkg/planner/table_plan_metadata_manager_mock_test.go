...
type TablePlanMetadataManagerMockGetStatInfoExpectation struct {
	...
	expectationOrigins TablePlanMetadataManagerMockGetStatInfoExpectationOrigins
...
// TablePlanMetadataManagerMockGetStatInfoOrigins contains origins of expectations of the tablePlanMetadataManager.GetStatInfo
type TablePlanMetadataManagerMockGetStatInfoExpectationOrigins struct {
	origin          string
...
func (mmGetStatInfo *mTablePlanMetadataManagerMockGetStatInfo) Expect(tableName string, layout records.Layout, trx scan.TRXInt) *mTablePlanMetadataManagerMockGetStatInfo {
	...
	mmGetStatInfo.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetStatInfo *mTablePlanMetadataManagerMockGetStatInfo) ExpectTableNameParam1(tableName string) *mTablePlanMetadataManagerMockGetStatInfo {
	...
	mmGetStatInfo.defaultExpectation.expectationOrigins.originTableName = minimock.CallerInfo(1)
...
func (mmGetStatInfo *mTablePlanMetadataManagerMockGetStatInfo) ExpectLayoutParam2(layout records.Layout) *mTablePlanMetadataManagerMockGetStatInfo {
	...
	mmGetStatInfo.defaultExpectation.expectationOrigins.originLayout = minimock.CallerInfo(1)
...
func (mmGetStatInfo *mTablePlanMetadataManagerMockGetStatInfo) ExpectTrxParam3(trx scan.TRXInt) *mTablePlanMetadataManagerMockGetStatInfo {
	...
	mmGetStatInfo.defaultExpectation.expectationOrigins.originTrx = minimock.CallerInfo(1)
...
func (mmGetStatInfo *mTablePlanMetadataManagerMockGetStatInfo) Return(s1 metadata.StatInfo, err error) *TablePlanMetadataManagerMock {
	...
	mmGetStatInfo.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetStatInfo *mTablePlanMetadataManagerMockGetStatInfo) Set(f func(tableName string, layout records.Layout, trx scan.TRXInt) (s1 metadata.StatInfo, err error)) *TablePlanMetadataManagerMock {
	...
	mmGetStatInfo.mock.funcGetStatInfoOrigin = minimock.CallerInfo(1)
	return mmGetStatInfo.mock
}
...
func (mmGetStatInfo *mTablePlanMetadataManagerMockGetStatInfo) When(tableName string, layout records.Layout, trx scan.TRXInt) *TablePlanMetadataManagerMockGetStatInfoExpectation {
	...
	expectation := &TablePlanMetadataManagerMockGetStatInfoExpectation{
		...
		expectationOrigins: TablePlanMetadataManagerMockGetStatInfoExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetStatInfo *mTablePlanMetadataManagerMockGetStatInfo) Times(n uint64) *mTablePlanMetadataManagerMockGetStatInfo {
	...
	mmGetStatInfo.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetStatInfo
}
	...
	if mmGetStatInfo.GetStatInfoMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.tableName != nil && !minimock.Equal(*mm_want_ptrs.tableName, mm_got.tableName) {
				mmGetStatInfo.t.Errorf("TablePlanMetadataManagerMock.GetStatInfo got unexpected parameter tableName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetStatInfo.GetStatInfoMock.defaultExpectation.expectationOrigins.originTableName, *mm_want_ptrs.tableName, mm_got.tableName, minimock.Diff(*mm_want_ptrs.tableName, mm_got.tableName))
			}

			if mm_want_ptrs.layout != nil && !minimock.Equal(*mm_want_ptrs.layout, mm_got.layout) {
				mmGetStatInfo.t.Errorf("TablePlanMetadataManagerMock.GetStatInfo got unexpected parameter layout, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetStatInfo.GetStatInfoMock.defaultExpectation.expectationOrigins.originLayout, *mm_want_ptrs.layout, mm_got.layout, minimock.Diff(*mm_want_ptrs.layout, mm_got.layout))
			}

			if mm_want_ptrs.trx != nil && !minimock.Equal(*mm_want_ptrs.trx, mm_got.trx) {
				mmGetStatInfo.t.Errorf("TablePlanMetadataManagerMock.GetStatInfo got unexpected parameter trx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetStatInfo.GetStatInfoMock.defaultExpectation.expectationOrigins.originTrx, *mm_want_ptrs.trx, mm_got.trx, minimock.Diff(*mm_want_ptrs.trx, mm_got.trx))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetStatInfo.t.Errorf("TablePlanMetadataManagerMock.GetStatInfo got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetStatInfo.GetStatInfoMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TablePlanMetadataManagerMock) MinimockGetStatInfoInspect() {
	for _, e := range m.GetStatInfoMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TablePlanMetadataManagerMock.GetStatInfo at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetStatInfoMock.defaultExpectation != nil && afterGetStatInfoCounter < 1 {
		if m.GetStatInfoMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to TablePlanMetadataManagerMock.GetStatInfo at\n%s", m.GetStatInfoMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to TablePlanMetadataManagerMock.GetStatInfo at\n%s with params: %#v", m.GetStatInfoMock.defaultExpectation.expectationOrigins.origin, *m.GetStatInfoMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetStatInfo != nil && afterGetStatInfoCounter < 1 {
		m.t.Errorf("Expected call to TablePlanMetadataManagerMock.GetStatInfo at\n%s", m.funcGetStatInfoOrigin)
	}

	if !m.GetStatInfoMock.invocationsDone() && afterGetStatInfoCounter > 0 {
		m.t.Errorf("Expected %d calls to TablePlanMetadataManagerMock.GetStatInfo at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetStatInfoMock.expectedInvocations), m.GetStatInfoMock.expectedInvocationsOrigin, afterGetStatInfoCounter)
	}
}
...
type TablePlanMetadataManagerMockLayoutExpectation struct {
	...
	expectationOrigins TablePlanMetadataManagerMockLayoutExpectationOrigins
...
// TablePlanMetadataManagerMockLayoutOrigins contains origins of expectations of the tablePlanMetadataManager.Layout
type TablePlanMetadataManagerMockLayoutExpectationOrigins struct {
	origin          string
	originTableName string
	originTrx       string
}
...
func (mmLayout *mTablePlanMetadataManagerMockLayout) Expect(tableName string, trx scan.TRXInt) *mTablePlanMetadataManagerMockLayout {
	...
	mmLayout.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmLayout *mTablePlanMetadataManagerMockLayout) ExpectTableNameParam1(tableName string) *mTablePlanMetadataManagerMockLayout {
	...
	mmLayout.defaultExpectation.expectationOrigins.originTableName = minimock.CallerInfo(1)
...
func (mmLayout *mTablePlanMetadataManagerMockLayout) ExpectTrxParam2(trx scan.TRXInt) *mTablePlanMetadataManagerMockLayout {
	...
	mmLayout.defaultExpectation.expectationOrigins.originTrx = minimock.CallerInfo(1)
...
func (mmLayout *mTablePlanMetadataManagerMockLayout) Return(l1 records.Layout, err error) *TablePlanMetadataManagerMock {
	...
	mmLayout.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmLayout *mTablePlanMetadataManagerMockLayout) Set(f func(tableName string, trx scan.TRXInt) (l1 records.Layout, err error)) *TablePlanMetadataManagerMock {
	...
	mmLayout.mock.funcLayoutOrigin = minimock.CallerInfo(1)
	return mmLayout.mock
}
...
func (mmLayout *mTablePlanMetadataManagerMockLayout) When(tableName string, trx scan.TRXInt) *TablePlanMetadataManagerMockLayoutExpectation {
	...
	expectation := &TablePlanMetadataManagerMockLayoutExpectation{
		...
		expectationOrigins: TablePlanMetadataManagerMockLayoutExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmLayout *mTablePlanMetadataManagerMockLayout) Times(n uint64) *mTablePlanMetadataManagerMockLayout {
	...
	mmLayout.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmLayout
}
...
func (mmLayout *TablePlanMetadataManagerMock) Layout(tableName string, trx scan.TRXInt) (l1 records.Layout, err error) {
	...
	if mmLayout.LayoutMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.tableName != nil && !minimock.Equal(*mm_want_ptrs.tableName, mm_got.tableName) {
				mmLayout.t.Errorf("TablePlanMetadataManagerMock.Layout got unexpected parameter tableName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmLayout.LayoutMock.defaultExpectation.expectationOrigins.originTableName, *mm_want_ptrs.tableName, mm_got.tableName, minimock.Diff(*mm_want_ptrs.tableName, mm_got.tableName))
			}

			if mm_want_ptrs.trx != nil && !minimock.Equal(*mm_want_ptrs.trx, mm_got.trx) {
				mmLayout.t.Errorf("TablePlanMetadataManagerMock.Layout got unexpected parameter trx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmLayout.LayoutMock.defaultExpectation.expectationOrigins.originTrx, *mm_want_ptrs.trx, mm_got.trx, minimock.Diff(*mm_want_ptrs.trx, mm_got.trx))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmLayout.t.Errorf("TablePlanMetadataManagerMock.Layout got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmLayout.LayoutMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TablePlanMetadataManagerMock) MinimockLayoutInspect() {
	for _, e := range m.LayoutMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TablePlanMetadataManagerMock.Layout at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.LayoutMock.defaultExpectation != nil && afterLayoutCounter < 1 {
		if m.LayoutMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to TablePlanMetadataManagerMock.Layout at\n%s", m.LayoutMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to TablePlanMetadataManagerMock.Layout at\n%s with params: %#v", m.LayoutMock.defaultExpectation.expectationOrigins.origin, *m.LayoutMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcLayout != nil && afterLayoutCounter < 1 {
		m.t.Errorf("Expected call to TablePlanMetadataManagerMock.Layout at\n%s", m.funcLayoutOrigin)
	}

	if !m.LayoutMock.invocationsDone() && afterLayoutCounter > 0 {
		m.t.Errorf("Expected %d calls to TablePlanMetadataManagerMock.Layout at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.LayoutMock.expectedInvocations), m.LayoutMock.expectedInvocationsOrigin, afterLayoutCounter)
	}
}
