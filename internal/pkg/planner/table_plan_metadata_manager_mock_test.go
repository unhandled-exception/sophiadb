...
//go:generate minimock -i github.com/unhandled-exception/sophiadb/internal/pkg/planner.tablePlanMetadataManager -o ./table_plan_metadata_manager_mock_test.go -n TablePlanMetadataManagerMock
