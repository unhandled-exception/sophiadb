...
// PredicateMock implements mm_scan.Predicate
type PredicateMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcConjoinWith          func(p1 mm_scan.Predicate)
	funcConjoinWithOrigin    string
	...
	funcEquatesWithConstantOrigin    string
	...
	funcEquatesWithFieldOrigin    string
	...
	funcReductionFactorOrigin    string
	...
	funcSelectSubPredOrigin    string
...
// NewPredicateMock returns a mock for mm_scan.Predicate
...
type PredicateMockConjoinWithExpectation struct {
	...
	expectationOrigins PredicateMockConjoinWithExpectationOrigins
...
// PredicateMockConjoinWithOrigins contains origins of expectations of the Predicate.ConjoinWith
type PredicateMockConjoinWithExpectationOrigins struct {
	origin   string
	originP1 string
}
...
func (mmConjoinWith *mPredicateMockConjoinWith) Expect(p1 mm_scan.Predicate) *mPredicateMockConjoinWith {
	...
	mmConjoinWith.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmConjoinWith *mPredicateMockConjoinWith) ExpectP1Param1(p1 mm_scan.Predicate) *mPredicateMockConjoinWith {
	...
	mmConjoinWith.defaultExpectation.expectationOrigins.originP1 = minimock.CallerInfo(1)
...
func (mmConjoinWith *mPredicateMockConjoinWith) Return() *PredicateMock {
	...
	mmConjoinWith.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmConjoinWith *mPredicateMockConjoinWith) Set(f func(p1 mm_scan.Predicate)) *PredicateMock {
	...
	mmConjoinWith.mock.funcConjoinWithOrigin = minimock.CallerInfo(1)
	return mmConjoinWith.mock
}

// When sets expectation for the Predicate.ConjoinWith which will trigger the result defined by the following
// Then helper
func (mmConjoinWith *mPredicateMockConjoinWith) When(p1 mm_scan.Predicate) *PredicateMockConjoinWithExpectation {
	if mmConjoinWith.mock.funcConjoinWith != nil {
		mmConjoinWith.mock.t.Fatalf("PredicateMock.ConjoinWith mock is already set by Set")
	}

	expectation := &PredicateMockConjoinWithExpectation{
		mock:               mmConjoinWith.mock,
		params:             &PredicateMockConjoinWithParams{p1},
		expectationOrigins: PredicateMockConjoinWithExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmConjoinWith.expectations = append(mmConjoinWith.expectations, expectation)
	return expectation
}

// Then sets up Predicate.ConjoinWith return parameters for the expectation previously defined by the When method

func (e *PredicateMockConjoinWithExpectation) Then() *PredicateMock {
	return e.mock
}
...
func (mmConjoinWith *mPredicateMockConjoinWith) Times(n uint64) *mPredicateMockConjoinWith {
	...
	mmConjoinWith.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmConjoinWith
}
...
// ConjoinWith implements mm_scan.Predicate
	...
	if mmConjoinWith.ConjoinWithMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.p1 != nil && !minimock.Equal(*mm_want_ptrs.p1, mm_got.p1) {
				mmConjoinWith.t.Errorf("PredicateMock.ConjoinWith got unexpected parameter p1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmConjoinWith.ConjoinWithMock.defaultExpectation.expectationOrigins.originP1, *mm_want_ptrs.p1, mm_got.p1, minimock.Diff(*mm_want_ptrs.p1, mm_got.p1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmConjoinWith.t.Errorf("PredicateMock.ConjoinWith got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmConjoinWith.ConjoinWithMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *PredicateMock) MinimockConjoinWithInspect() {
	for _, e := range m.ConjoinWithMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to PredicateMock.ConjoinWith at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.ConjoinWithMock.defaultExpectation != nil && afterConjoinWithCounter < 1 {
		if m.ConjoinWithMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to PredicateMock.ConjoinWith at\n%s", m.ConjoinWithMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to PredicateMock.ConjoinWith at\n%s with params: %#v", m.ConjoinWithMock.defaultExpectation.expectationOrigins.origin, *m.ConjoinWithMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcConjoinWith != nil && afterConjoinWithCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.ConjoinWith at\n%s", m.funcConjoinWithOrigin)
	}

	if !m.ConjoinWithMock.invocationsDone() && afterConjoinWithCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.ConjoinWith at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.ConjoinWithMock.expectedInvocations), m.ConjoinWithMock.expectedInvocationsOrigin, afterConjoinWithCounter)
	}
}
...
type PredicateMockEquatesWithConstantExpectation struct {
	...
	expectationOrigins PredicateMockEquatesWithConstantExpectationOrigins
...
// PredicateMockEquatesWithConstantOrigins contains origins of expectations of the Predicate.EquatesWithConstant
type PredicateMockEquatesWithConstantExpectationOrigins struct {
	origin   string
	originS1 string
}
...
func (mmEquatesWithConstant *mPredicateMockEquatesWithConstant) Expect(s1 string) *mPredicateMockEquatesWithConstant {
	...
	mmEquatesWithConstant.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmEquatesWithConstant *mPredicateMockEquatesWithConstant) ExpectS1Param1(s1 string) *mPredicateMockEquatesWithConstant {
	...
	mmEquatesWithConstant.defaultExpectation.expectationOrigins.originS1 = minimock.CallerInfo(1)
...
func (mmEquatesWithConstant *mPredicateMockEquatesWithConstant) Return(c1 mm_scan.Constant, b1 bool) *PredicateMock {
	...
	mmEquatesWithConstant.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmEquatesWithConstant *mPredicateMockEquatesWithConstant) Set(f func(s1 string) (c1 mm_scan.Constant, b1 bool)) *PredicateMock {
	...
	mmEquatesWithConstant.mock.funcEquatesWithConstantOrigin = minimock.CallerInfo(1)
	return mmEquatesWithConstant.mock
}
...
func (mmEquatesWithConstant *mPredicateMockEquatesWithConstant) When(s1 string) *PredicateMockEquatesWithConstantExpectation {
	...
	expectation := &PredicateMockEquatesWithConstantExpectation{
		...
		expectationOrigins: PredicateMockEquatesWithConstantExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmEquatesWithConstant *mPredicateMockEquatesWithConstant) Times(n uint64) *mPredicateMockEquatesWithConstant {
	...
	mmEquatesWithConstant.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmEquatesWithConstant
}
...
// EquatesWithConstant implements mm_scan.Predicate
func (mmEquatesWithConstant *PredicateMock) EquatesWithConstant(s1 string) (c1 mm_scan.Constant, b1 bool) {
	...
	mmEquatesWithConstant.t.Helper()
	...
	if mmEquatesWithConstant.EquatesWithConstantMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.s1 != nil && !minimock.Equal(*mm_want_ptrs.s1, mm_got.s1) {
				mmEquatesWithConstant.t.Errorf("PredicateMock.EquatesWithConstant got unexpected parameter s1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmEquatesWithConstant.EquatesWithConstantMock.defaultExpectation.expectationOrigins.originS1, *mm_want_ptrs.s1, mm_got.s1, minimock.Diff(*mm_want_ptrs.s1, mm_got.s1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmEquatesWithConstant.t.Errorf("PredicateMock.EquatesWithConstant got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmEquatesWithConstant.EquatesWithConstantMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *PredicateMock) MinimockEquatesWithConstantInspect() {
	for _, e := range m.EquatesWithConstantMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to PredicateMock.EquatesWithConstant at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.EquatesWithConstantMock.defaultExpectation != nil && afterEquatesWithConstantCounter < 1 {
		if m.EquatesWithConstantMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to PredicateMock.EquatesWithConstant at\n%s", m.EquatesWithConstantMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to PredicateMock.EquatesWithConstant at\n%s with params: %#v", m.EquatesWithConstantMock.defaultExpectation.expectationOrigins.origin, *m.EquatesWithConstantMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcEquatesWithConstant != nil && afterEquatesWithConstantCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.EquatesWithConstant at\n%s", m.funcEquatesWithConstantOrigin)
	}

	if !m.EquatesWithConstantMock.invocationsDone() && afterEquatesWithConstantCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.EquatesWithConstant at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.EquatesWithConstantMock.expectedInvocations), m.EquatesWithConstantMock.expectedInvocationsOrigin, afterEquatesWithConstantCounter)
	}
}
...
type PredicateMockEquatesWithFieldExpectation struct {
	...
	expectationOrigins PredicateMockEquatesWithFieldExpectationOrigins
...
// PredicateMockEquatesWithFieldOrigins contains origins of expectations of the Predicate.EquatesWithField
type PredicateMockEquatesWithFieldExpectationOrigins struct {
	origin   string
	originS1 string
}
...
func (mmEquatesWithField *mPredicateMockEquatesWithField) Expect(s1 string) *mPredicateMockEquatesWithField {
	...
	mmEquatesWithField.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmEquatesWithField *mPredicateMockEquatesWithField) ExpectS1Param1(s1 string) *mPredicateMockEquatesWithField {
	...
	mmEquatesWithField.defaultExpectation.expectationOrigins.originS1 = minimock.CallerInfo(1)
...
func (mmEquatesWithField *mPredicateMockEquatesWithField) Return(s2 string, b1 bool) *PredicateMock {
	...
	mmEquatesWithField.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmEquatesWithField *mPredicateMockEquatesWithField) Set(f func(s1 string) (s2 string, b1 bool)) *PredicateMock {
	...
	mmEquatesWithField.mock.funcEquatesWithFieldOrigin = minimock.CallerInfo(1)
	return mmEquatesWithField.mock
}
...
func (mmEquatesWithField *mPredicateMockEquatesWithField) When(s1 string) *PredicateMockEquatesWithFieldExpectation {
	...
	expectation := &PredicateMockEquatesWithFieldExpectation{
		...
		expectationOrigins: PredicateMockEquatesWithFieldExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmEquatesWithField *mPredicateMockEquatesWithField) Times(n uint64) *mPredicateMockEquatesWithField {
	...
	mmEquatesWithField.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmEquatesWithField
}
...
// EquatesWithField implements mm_scan.Predicate
func (mmEquatesWithField *PredicateMock) EquatesWithField(s1 string) (s2 string, b1 bool) {
	...
	if mmEquatesWithField.EquatesWithFieldMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.s1 != nil && !minimock.Equal(*mm_want_ptrs.s1, mm_got.s1) {
				mmEquatesWithField.t.Errorf("PredicateMock.EquatesWithField got unexpected parameter s1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmEquatesWithField.EquatesWithFieldMock.defaultExpectation.expectationOrigins.originS1, *mm_want_ptrs.s1, mm_got.s1, minimock.Diff(*mm_want_ptrs.s1, mm_got.s1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmEquatesWithField.t.Errorf("PredicateMock.EquatesWithField got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmEquatesWithField.EquatesWithFieldMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *PredicateMock) MinimockEquatesWithFieldInspect() {
	for _, e := range m.EquatesWithFieldMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to PredicateMock.EquatesWithField at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.EquatesWithFieldMock.defaultExpectation != nil && afterEquatesWithFieldCounter < 1 {
		if m.EquatesWithFieldMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to PredicateMock.EquatesWithField at\n%s", m.EquatesWithFieldMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to PredicateMock.EquatesWithField at\n%s with params: %#v", m.EquatesWithFieldMock.defaultExpectation.expectationOrigins.origin, *m.EquatesWithFieldMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcEquatesWithField != nil && afterEquatesWithFieldCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.EquatesWithField at\n%s", m.funcEquatesWithFieldOrigin)
	}

	if !m.EquatesWithFieldMock.invocationsDone() && afterEquatesWithFieldCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.EquatesWithField at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.EquatesWithFieldMock.expectedInvocations), m.EquatesWithFieldMock.expectedInvocationsOrigin, afterEquatesWithFieldCounter)
	}
}
...
type PredicateMockIsSatisfiedExpectation struct {
	...
	expectationOrigins PredicateMockIsSatisfiedExpectationOrigins
...
// PredicateMockIsSatisfiedOrigins contains origins of expectations of the Predicate.IsSatisfied
type PredicateMockIsSatisfiedExpectationOrigins struct {
	origin   string
	originS1 string
}
...
func (mmIsSatisfied *mPredicateMockIsSatisfied) Expect(s1 mm_scan.Scan) *mPredicateMockIsSatisfied {
	...
	mmIsSatisfied.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmIsSatisfied *mPredicateMockIsSatisfied) ExpectS1Param1(s1 mm_scan.Scan) *mPredicateMockIsSatisfied {
	...
	mmIsSatisfied.defaultExpectation.expectationOrigins.originS1 = minimock.CallerInfo(1)
...
func (mmIsSatisfied *mPredicateMockIsSatisfied) Return(b1 bool, err error) *PredicateMock {
	...
	mmIsSatisfied.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmIsSatisfied *mPredicateMockIsSatisfied) Set(f func(s1 mm_scan.Scan) (b1 bool, err error)) *PredicateMock {
	...
	mmIsSatisfied.mock.funcIsSatisfiedOrigin = minimock.CallerInfo(1)
	return mmIsSatisfied.mock
}
...
func (mmIsSatisfied *mPredicateMockIsSatisfied) When(s1 mm_scan.Scan) *PredicateMockIsSatisfiedExpectation {
	...
	expectation := &PredicateMockIsSatisfiedExpectation{
		...
		expectationOrigins: PredicateMockIsSatisfiedExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmIsSatisfied *mPredicateMockIsSatisfied) Times(n uint64) *mPredicateMockIsSatisfied {
	...
	mmIsSatisfied.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmIsSatisfied
}
...
// IsSatisfied implements mm_scan.Predicate
func (mmIsSatisfied *PredicateMock) IsSatisfied(s1 mm_scan.Scan) (b1 bool, err error) {
	...
	if mmIsSatisfied.IsSatisfiedMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.s1 != nil && !minimock.Equal(*mm_want_ptrs.s1, mm_got.s1) {
				mmIsSatisfied.t.Errorf("PredicateMock.IsSatisfied got unexpected parameter s1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmIsSatisfied.IsSatisfiedMock.defaultExpectation.expectationOrigins.originS1, *mm_want_ptrs.s1, mm_got.s1, minimock.Diff(*mm_want_ptrs.s1, mm_got.s1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmIsSatisfied.t.Errorf("PredicateMock.IsSatisfied got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmIsSatisfied.IsSatisfiedMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *PredicateMock) MinimockIsSatisfiedInspect() {
	for _, e := range m.IsSatisfiedMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to PredicateMock.IsSatisfied at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.IsSatisfiedMock.defaultExpectation != nil && afterIsSatisfiedCounter < 1 {
		if m.IsSatisfiedMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to PredicateMock.IsSatisfied at\n%s", m.IsSatisfiedMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to PredicateMock.IsSatisfied at\n%s with params: %#v", m.IsSatisfiedMock.defaultExpectation.expectationOrigins.origin, *m.IsSatisfiedMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcIsSatisfied != nil && afterIsSatisfiedCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.IsSatisfied at\n%s", m.funcIsSatisfiedOrigin)
	}

	if !m.IsSatisfiedMock.invocationsDone() && afterIsSatisfiedCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.IsSatisfied at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.IsSatisfiedMock.expectedInvocations), m.IsSatisfiedMock.expectedInvocationsOrigin, afterIsSatisfiedCounter)
	}
}
...
type PredicateMockJoinSubPredExpectation struct {
	...
	expectationOrigins PredicateMockJoinSubPredExpectationOrigins
...
// PredicateMockJoinSubPredOrigins contains origins of expectations of the Predicate.JoinSubPred
type PredicateMockJoinSubPredExpectationOrigins struct {
	origin   string
	originS1 string
	originS2 string
}
...
func (mmJoinSubPred *mPredicateMockJoinSubPred) Expect(s1 records.Schema, s2 records.Schema) *mPredicateMockJoinSubPred {
	...
	mmJoinSubPred.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmJoinSubPred *mPredicateMockJoinSubPred) ExpectS1Param1(s1 records.Schema) *mPredicateMockJoinSubPred {
	...
	mmJoinSubPred.defaultExpectation.expectationOrigins.originS1 = minimock.CallerInfo(1)
...
func (mmJoinSubPred *mPredicateMockJoinSubPred) ExpectS2Param2(s2 records.Schema) *mPredicateMockJoinSubPred {
	...
	mmJoinSubPred.defaultExpectation.expectationOrigins.originS2 = minimock.CallerInfo(1)
...
func (mmJoinSubPred *mPredicateMockJoinSubPred) Return(p1 mm_scan.Predicate) *PredicateMock {
	...
	mmJoinSubPred.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmJoinSubPred *mPredicateMockJoinSubPred) Set(f func(s1 records.Schema, s2 records.Schema) (p1 mm_scan.Predicate)) *PredicateMock {
	...
	mmJoinSubPred.mock.funcJoinSubPredOrigin = minimock.CallerInfo(1)
	return mmJoinSubPred.mock
}
...
func (mmJoinSubPred *mPredicateMockJoinSubPred) When(s1 records.Schema, s2 records.Schema) *PredicateMockJoinSubPredExpectation {
	...
	expectation := &PredicateMockJoinSubPredExpectation{
		...
		expectationOrigins: PredicateMockJoinSubPredExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmJoinSubPred *mPredicateMockJoinSubPred) Times(n uint64) *mPredicateMockJoinSubPred {
	...
	mmJoinSubPred.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmJoinSubPred
}
...
// JoinSubPred implements mm_scan.Predicate
func (mmJoinSubPred *PredicateMock) JoinSubPred(s1 records.Schema, s2 records.Schema) (p1 mm_scan.Predicate) {
	...
	if mmJoinSubPred.JoinSubPredMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.s1 != nil && !minimock.Equal(*mm_want_ptrs.s1, mm_got.s1) {
				mmJoinSubPred.t.Errorf("PredicateMock.JoinSubPred got unexpected parameter s1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmJoinSubPred.JoinSubPredMock.defaultExpectation.expectationOrigins.originS1, *mm_want_ptrs.s1, mm_got.s1, minimock.Diff(*mm_want_ptrs.s1, mm_got.s1))
			}

			if mm_want_ptrs.s2 != nil && !minimock.Equal(*mm_want_ptrs.s2, mm_got.s2) {
				mmJoinSubPred.t.Errorf("PredicateMock.JoinSubPred got unexpected parameter s2, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmJoinSubPred.JoinSubPredMock.defaultExpectation.expectationOrigins.originS2, *mm_want_ptrs.s2, mm_got.s2, minimock.Diff(*mm_want_ptrs.s2, mm_got.s2))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmJoinSubPred.t.Errorf("PredicateMock.JoinSubPred got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmJoinSubPred.JoinSubPredMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *PredicateMock) MinimockJoinSubPredInspect() {
	for _, e := range m.JoinSubPredMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to PredicateMock.JoinSubPred at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.JoinSubPredMock.defaultExpectation != nil && afterJoinSubPredCounter < 1 {
		if m.JoinSubPredMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to PredicateMock.JoinSubPred at\n%s", m.JoinSubPredMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to PredicateMock.JoinSubPred at\n%s with params: %#v", m.JoinSubPredMock.defaultExpectation.expectationOrigins.origin, *m.JoinSubPredMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcJoinSubPred != nil && afterJoinSubPredCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.JoinSubPred at\n%s", m.funcJoinSubPredOrigin)
	}

	if !m.JoinSubPredMock.invocationsDone() && afterJoinSubPredCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.JoinSubPred at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.JoinSubPredMock.expectedInvocations), m.JoinSubPredMock.expectedInvocationsOrigin, afterJoinSubPredCounter)
	}
}
...
type PredicateMockReductionFactorExpectation struct {
	...
	expectationOrigins PredicateMockReductionFactorExpectationOrigins
...
// PredicateMockReductionFactorOrigins contains origins of expectations of the Predicate.ReductionFactor
type PredicateMockReductionFactorExpectationOrigins struct {
	origin   string
	originP1 string
}
...
func (mmReductionFactor *mPredicateMockReductionFactor) Expect(p1 mm_scan.Plan) *mPredicateMockReductionFactor {
	...
	mmReductionFactor.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmReductionFactor *mPredicateMockReductionFactor) ExpectP1Param1(p1 mm_scan.Plan) *mPredicateMockReductionFactor {
	...
	mmReductionFactor.defaultExpectation.expectationOrigins.originP1 = minimock.CallerInfo(1)
...
func (mmReductionFactor *mPredicateMockReductionFactor) Return(i1 int64, b1 bool) *PredicateMock {
	...
	mmReductionFactor.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmReductionFactor *mPredicateMockReductionFactor) Set(f func(p1 mm_scan.Plan) (i1 int64, b1 bool)) *PredicateMock {
	...
	mmReductionFactor.mock.funcReductionFactorOrigin = minimock.CallerInfo(1)
	return mmReductionFactor.mock
}
...
func (mmReductionFactor *mPredicateMockReductionFactor) When(p1 mm_scan.Plan) *PredicateMockReductionFactorExpectation {
	...
	expectation := &PredicateMockReductionFactorExpectation{
		...
		expectationOrigins: PredicateMockReductionFactorExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmReductionFactor *mPredicateMockReductionFactor) Times(n uint64) *mPredicateMockReductionFactor {
	...
	mmReductionFactor.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmReductionFactor
}
...
// ReductionFactor implements mm_scan.Predicate
func (mmReductionFactor *PredicateMock) ReductionFactor(p1 mm_scan.Plan) (i1 int64, b1 bool) {
	...
	if mmReductionFactor.ReductionFactorMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.p1 != nil && !minimock.Equal(*mm_want_ptrs.p1, mm_got.p1) {
				mmReductionFactor.t.Errorf("PredicateMock.ReductionFactor got unexpected parameter p1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmReductionFactor.ReductionFactorMock.defaultExpectation.expectationOrigins.originP1, *mm_want_ptrs.p1, mm_got.p1, minimock.Diff(*mm_want_ptrs.p1, mm_got.p1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmReductionFactor.t.Errorf("PredicateMock.ReductionFactor got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmReductionFactor.ReductionFactorMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *PredicateMock) MinimockReductionFactorInspect() {
	for _, e := range m.ReductionFactorMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to PredicateMock.ReductionFactor at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.ReductionFactorMock.defaultExpectation != nil && afterReductionFactorCounter < 1 {
		if m.ReductionFactorMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to PredicateMock.ReductionFactor at\n%s", m.ReductionFactorMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to PredicateMock.ReductionFactor at\n%s with params: %#v", m.ReductionFactorMock.defaultExpectation.expectationOrigins.origin, *m.ReductionFactorMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcReductionFactor != nil && afterReductionFactorCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.ReductionFactor at\n%s", m.funcReductionFactorOrigin)
	}

	if !m.ReductionFactorMock.invocationsDone() && afterReductionFactorCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.ReductionFactor at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.ReductionFactorMock.expectedInvocations), m.ReductionFactorMock.expectedInvocationsOrigin, afterReductionFactorCounter)
	}
}
...
type PredicateMockSelectSubPredExpectation struct {
	...
	expectationOrigins PredicateMockSelectSubPredExpectationOrigins
...
// PredicateMockSelectSubPredOrigins contains origins of expectations of the Predicate.SelectSubPred
type PredicateMockSelectSubPredExpectationOrigins struct {
	origin   string
	originS1 string
}
...
func (mmSelectSubPred *mPredicateMockSelectSubPred) Expect(s1 records.Schema) *mPredicateMockSelectSubPred {
	...
	mmSelectSubPred.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmSelectSubPred *mPredicateMockSelectSubPred) ExpectS1Param1(s1 records.Schema) *mPredicateMockSelectSubPred {
	...
	mmSelectSubPred.defaultExpectation.expectationOrigins.originS1 = minimock.CallerInfo(1)
...
func (mmSelectSubPred *mPredicateMockSelectSubPred) Return(p1 mm_scan.Predicate) *PredicateMock {
	...
	mmSelectSubPred.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmSelectSubPred *mPredicateMockSelectSubPred) Set(f func(s1 records.Schema) (p1 mm_scan.Predicate)) *PredicateMock {
	...
	mmSelectSubPred.mock.funcSelectSubPredOrigin = minimock.CallerInfo(1)
	return mmSelectSubPred.mock
}
...
func (mmSelectSubPred *mPredicateMockSelectSubPred) When(s1 records.Schema) *PredicateMockSelectSubPredExpectation {
	...
	expectation := &PredicateMockSelectSubPredExpectation{
		...
		expectationOrigins: PredicateMockSelectSubPredExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmSelectSubPred *mPredicateMockSelectSubPred) Times(n uint64) *mPredicateMockSelectSubPred {
	...
	mmSelectSubPred.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmSelectSubPred
}
...
// SelectSubPred implements mm_scan.Predicate
func (mmSelectSubPred *PredicateMock) SelectSubPred(s1 records.Schema) (p1 mm_scan.Predicate) {
	...
	if mmSelectSubPred.SelectSubPredMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.s1 != nil && !minimock.Equal(*mm_want_ptrs.s1, mm_got.s1) {
				mmSelectSubPred.t.Errorf("PredicateMock.SelectSubPred got unexpected parameter s1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSelectSubPred.SelectSubPredMock.defaultExpectation.expectationOrigins.originS1, *mm_want_ptrs.s1, mm_got.s1, minimock.Diff(*mm_want_ptrs.s1, mm_got.s1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSelectSubPred.t.Errorf("PredicateMock.SelectSubPred got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmSelectSubPred.SelectSubPredMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *PredicateMock) MinimockSelectSubPredInspect() {
	for _, e := range m.SelectSubPredMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to PredicateMock.SelectSubPred at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.SelectSubPredMock.defaultExpectation != nil && afterSelectSubPredCounter < 1 {
		if m.SelectSubPredMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to PredicateMock.SelectSubPred at\n%s", m.SelectSubPredMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to PredicateMock.SelectSubPred at\n%s with params: %#v", m.SelectSubPredMock.defaultExpectation.expectationOrigins.origin, *m.SelectSubPredMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcSelectSubPred != nil && afterSelectSubPredCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.SelectSubPred at\n%s", m.funcSelectSubPredOrigin)
	}

	if !m.SelectSubPredMock.invocationsDone() && afterSelectSubPredCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.SelectSubPred at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.SelectSubPredMock.expectedInvocations), m.SelectSubPredMock.expectedInvocationsOrigin, afterSelectSubPredCounter)
	}
}
...
// String implements mm_scan.Predicate
...
func (m *PredicateMock) MinimockStringInspect() {
	...
	if m.StringMock.defaultExpectation != nil && afterStringCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.String at\n%s", m.StringMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.StringMock.invocationsDone() && afterStringCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.String at\n%s but found %d calls",
...
func (mmTerms *mPredicateMockTerms) Return(ta1 []mm_scan.Term) *PredicateMock {
	...
	mmTerms.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmTerms.mock
}
...
func (mmTerms *mPredicateMockTerms) Set(f func() (ta1 []mm_scan.Term)) *PredicateMock {
	...
	mmTerms.mock.funcTermsOrigin = minimock.CallerInfo(1)
	return mmTerms.mock
}
...
func (mmTerms *mPredicateMockTerms) Times(n uint64) *mPredicateMockTerms {
	...
	mmTerms.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmTerms
}
...
// Terms implements mm_scan.Predicate
...
func (m *PredicateMock) MinimockTermsInspect() {
	...
	if m.TermsMock.defaultExpectation != nil && afterTermsCounter < 1 {
		m.t.Errorf("Expected call to PredicateMock.Terms at\n%s", m.TermsMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.TermsMock.invocationsDone() && afterTermsCounter > 0 {
		m.t.Errorf("Expected %d calls to PredicateMock.Terms at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.TermsMock.expectedInvocations), m.TermsMock.expectedInvocationsOrigin, afterTermsCounter)
	}
}
