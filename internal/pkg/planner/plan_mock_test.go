...
func (m *PlanMock) MinimockBlocksAccessedInspect() {
	...
	if m.BlocksAccessedMock.defaultExpectation != nil && afterBlocksAccessedCounter < 1 {
		m.t.Errorf("Expected call to PlanMock.BlocksAccessed at\n%s", m.BlocksAccessedMock.defaultExpectation.returnOrigin)
	}
	...
	if !m.BlocksAccessedMock.invocationsDone() && afterBlocksAccessedCounter > 0 {
		m.t.Errorf("Expected %d calls to PlanMock.BlocksAccessed at\n%s but found %d calls",
...
type PlanMockDistinctValuesExpectation struct {
	...
	expectationOrigins PlanMockDistinctValuesExpectationOrigins
...
// PlanMockDistinctValuesOrigins contains origins of expectations of the Plan.DistinctValues
type PlanMockDistinctValuesExpectationOrigins struct {
	origin   string
	originS1 string
}
...
func (mmDistinctValues *mPlanMockDistinctValues) ExpectS1Param1(s1 string) *mPlanMockDistinctValues {
	...
	mmDistinctValues.defaultExpectation.expectationOrigins.originS1 = minimock.CallerInfo(1)
...
func (mmDistinctValues *mPlanMockDistinctValues) When(s1 string) *PlanMockDistinctValuesExpectation {
	...
	expectation := &PlanMockDistinctValuesExpectation{
		...
		expectationOrigins: PlanMockDistinctValuesExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	...
	if mmDistinctValues.DistinctValuesMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.s1 != nil && !minimock.Equal(*mm_want_ptrs.s1, mm_got.s1) {
				mmDistinctValues.t.Errorf("PlanMock.DistinctValues got unexpected parameter s1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDistinctValues.DistinctValuesMock.defaultExpectation.expectationOrigins.originS1, *mm_want_ptrs.s1, mm_got.s1, minimock.Diff(*mm_want_ptrs.s1, mm_got.s1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDistinctValues.t.Errorf("PlanMock.DistinctValues got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *PlanMock) MinimockDistinctValuesInspect() {
	for _, e := range m.DistinctValuesMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to PlanMock.DistinctValues at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.DistinctValuesMock.invocationsDone() && afterDistinctValuesCounter > 0 {
		m.t.Errorf("Expected %d calls to PlanMock.DistinctValues at\n%s but found %d calls",
...
func (m *PlanMock) MinimockOpenInspect() {
	...
	if m.OpenMock.defaultExpectation != nil && afterOpenCounter < 1 {
		m.t.Errorf("Expected call to PlanMock.Open at\n%s", m.OpenMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.OpenMock.invocationsDone() && afterOpenCounter > 0 {
		m.t.Errorf("Expected %d calls to PlanMock.Open at\n%s but found %d calls",
...
func (m *PlanMock) MinimockRecordsInspect() {
	...
	if m.RecordsMock.defaultExpectation != nil && afterRecordsCounter < 1 {
		m.t.Errorf("Expected call to PlanMock.Records at\n%s", m.RecordsMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.RecordsMock.invocationsDone() && afterRecordsCounter > 0 {
		m.t.Errorf("Expected %d calls to PlanMock.Records at\n%s but found %d calls",
...
func (m *PlanMock) MinimockSchemaInspect() {
	...
	if m.SchemaMock.defaultExpectation != nil && afterSchemaCounter < 1 {
		m.t.Errorf("Expected call to PlanMock.Schema at\n%s", m.SchemaMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.SchemaMock.invocationsDone() && afterSchemaCounter > 0 {
		m.t.Errorf("Expected %d calls to PlanMock.Schema at\n%s but found %d calls",
...
func (m *PlanMock) MinimockStringInspect() {
	...
	if m.StringMock.defaultExpectation != nil && afterStringCounter < 1 {
		m.t.Errorf("Expected call to PlanMock.String at\n%s", m.StringMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.StringMock.invocationsDone() && afterStringCounter > 0 {
		m.t.Errorf("Expected %d calls to PlanMock.String at\n%s but found %d calls",
