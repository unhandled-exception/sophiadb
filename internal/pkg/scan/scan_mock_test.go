...
func (mmBeforeFirst *mScanMockBeforeFirst) Return(err error) *ScanMock {
	...
	mmBeforeFirst.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmBeforeFirst *mScanMockBeforeFirst) Set(f func() (err error)) *ScanMock {
	...
	mmBeforeFirst.mock.funcBeforeFirstOrigin = minimock.CallerInfo(1)
	return mmBeforeFirst.mock
}
...
func (mmBeforeFirst *mScanMockBeforeFirst) Times(n uint64) *mScanMockBeforeFirst {
	...
	mmBeforeFirst.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmBeforeFirst
}
...
func (m *ScanMock) MinimockBeforeFirstInspect() {
	...
	if m.BeforeFirstMock.defaultExpectation != nil && afterBeforeFirstCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.BeforeFirst at\n%s", m.BeforeFirstMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	if m.funcBeforeFirst != nil && afterBeforeFirstCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.BeforeFirst at\n%s", m.funcBeforeFirstOrigin)
	}

	if !m.BeforeFirstMock.invocationsDone() && afterBeforeFirstCounter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.BeforeFirst at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.BeforeFirstMock.expectedInvocations), m.BeforeFirstMock.expectedInvocationsOrigin, afterBeforeFirstCounter)
	}
}
...
func (m *ScanMock) MinimockCloseInspect() {
	...
	if m.CloseMock.defaultExpectation != nil && afterCloseCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.Close at\n%s", m.CloseMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.CloseMock.invocationsDone() && afterCloseCounter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.Close at\n%s but found %d calls",
...
type ScanMockGetInt64Expectation struct {
	...
	expectationOrigins ScanMockGetInt64ExpectationOrigins
...
// ScanMockGetInt64Origins contains origins of expectations of the Scan.GetInt64
type ScanMockGetInt64ExpectationOrigins struct {
	origin          string
...
func (mmGetInt64 *mScanMockGetInt64) Expect(fieldName string) *mScanMockGetInt64 {
	...
	mmGetInt64.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetInt64 *mScanMockGetInt64) ExpectFieldNameParam1(fieldName string) *mScanMockGetInt64 {
	...
	mmGetInt64.defaultExpectation.expectationOrigins.originFieldName = minimock.CallerInfo(1)
...
func (mmGetInt64 *mScanMockGetInt64) Return(i1 int64, err error) *ScanMock {
	...
	mmGetInt64.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetInt64 *mScanMockGetInt64) Set(f func(fieldName string) (i1 int64, err error)) *ScanMock {
	...
	mmGetInt64.mock.funcGetInt64Origin = minimock.CallerInfo(1)
	return mmGetInt64.mock
}
...
func (mmGetInt64 *mScanMockGetInt64) When(fieldName string) *ScanMockGetInt64Expectation {
	...
	expectation := &ScanMockGetInt64Expectation{
		...
		expectationOrigins: ScanMockGetInt64ExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetInt64 *mScanMockGetInt64) Times(n uint64) *mScanMockGetInt64 {
	...
	mmGetInt64.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetInt64
}
	...
	if mmGetInt64.GetInt64Mock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fieldName != nil && !minimock.Equal(*mm_want_ptrs.fieldName, mm_got.fieldName) {
				mmGetInt64.t.Errorf("ScanMock.GetInt64 got unexpected parameter fieldName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetInt64.GetInt64Mock.defaultExpectation.expectationOrigins.originFieldName, *mm_want_ptrs.fieldName, mm_got.fieldName, minimock.Diff(*mm_want_ptrs.fieldName, mm_got.fieldName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetInt64.t.Errorf("ScanMock.GetInt64 got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetInt64.GetInt64Mock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ScanMock) MinimockGetInt64Inspect() {
	for _, e := range m.GetInt64Mock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ScanMock.GetInt64 at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetInt64Mock.defaultExpectation != nil && afterGetInt64Counter < 1 {
		if m.GetInt64Mock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ScanMock.GetInt64 at\n%s", m.GetInt64Mock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ScanMock.GetInt64 at\n%s with params: %#v", m.GetInt64Mock.defaultExpectation.expectationOrigins.origin, *m.GetInt64Mock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetInt64 != nil && afterGetInt64Counter < 1 {
		m.t.Errorf("Expected call to ScanMock.GetInt64 at\n%s", m.funcGetInt64Origin)
	}

	if !m.GetInt64Mock.invocationsDone() && afterGetInt64Counter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.GetInt64 at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetInt64Mock.expectedInvocations), m.GetInt64Mock.expectedInvocationsOrigin, afterGetInt64Counter)
	}
}
...
type ScanMockGetInt8Expectation struct {
	...
	expectationOrigins ScanMockGetInt8ExpectationOrigins
...
// ScanMockGetInt8Origins contains origins of expectations of the Scan.GetInt8
type ScanMockGetInt8ExpectationOrigins struct {
	origin          string
	originFieldName string
}
...
func (mmGetInt8 *mScanMockGetInt8) Expect(fieldName string) *mScanMockGetInt8 {
	...
	mmGetInt8.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetInt8 *mScanMockGetInt8) ExpectFieldNameParam1(fieldName string) *mScanMockGetInt8 {
	...
	mmGetInt8.defaultExpectation.expectationOrigins.originFieldName = minimock.CallerInfo(1)
...
func (mmGetInt8 *mScanMockGetInt8) Return(i1 int8, err error) *ScanMock {
	...
	mmGetInt8.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetInt8 *mScanMockGetInt8) Set(f func(fieldName string) (i1 int8, err error)) *ScanMock {
	...
	mmGetInt8.mock.funcGetInt8Origin = minimock.CallerInfo(1)
	return mmGetInt8.mock
}
...
func (mmGetInt8 *mScanMockGetInt8) When(fieldName string) *ScanMockGetInt8Expectation {
	...
	expectation := &ScanMockGetInt8Expectation{
		...
		expectationOrigins: ScanMockGetInt8ExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetInt8 *mScanMockGetInt8) Times(n uint64) *mScanMockGetInt8 {
	...
	mmGetInt8.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetInt8
}
...
func (mmGetInt8 *ScanMock) GetInt8(fieldName string) (i1 int8, err error) {
	...
	if mmGetInt8.GetInt8Mock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fieldName != nil && !minimock.Equal(*mm_want_ptrs.fieldName, mm_got.fieldName) {
				mmGetInt8.t.Errorf("ScanMock.GetInt8 got unexpected parameter fieldName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetInt8.GetInt8Mock.defaultExpectation.expectationOrigins.originFieldName, *mm_want_ptrs.fieldName, mm_got.fieldName, minimock.Diff(*mm_want_ptrs.fieldName, mm_got.fieldName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetInt8.t.Errorf("ScanMock.GetInt8 got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetInt8.GetInt8Mock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ScanMock) MinimockGetInt8Inspect() {
	for _, e := range m.GetInt8Mock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ScanMock.GetInt8 at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetInt8Mock.defaultExpectation != nil && afterGetInt8Counter < 1 {
		if m.GetInt8Mock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ScanMock.GetInt8 at\n%s", m.GetInt8Mock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ScanMock.GetInt8 at\n%s with params: %#v", m.GetInt8Mock.defaultExpectation.expectationOrigins.origin, *m.GetInt8Mock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetInt8 != nil && afterGetInt8Counter < 1 {
		m.t.Errorf("Expected call to ScanMock.GetInt8 at\n%s", m.funcGetInt8Origin)
	}

	if !m.GetInt8Mock.invocationsDone() && afterGetInt8Counter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.GetInt8 at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetInt8Mock.expectedInvocations), m.GetInt8Mock.expectedInvocationsOrigin, afterGetInt8Counter)
	}
}
...
type ScanMockGetStringExpectation struct {
	...
	expectationOrigins ScanMockGetStringExpectationOrigins
...
// ScanMockGetStringOrigins contains origins of expectations of the Scan.GetString
type ScanMockGetStringExpectationOrigins struct {
	origin          string
	originFieldName string
}
...
func (mmGetString *mScanMockGetString) Expect(fieldName string) *mScanMockGetString {
	...
	mmGetString.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetString *mScanMockGetString) ExpectFieldNameParam1(fieldName string) *mScanMockGetString {
	...
	mmGetString.defaultExpectation.expectationOrigins.originFieldName = minimock.CallerInfo(1)
...
func (mmGetString *mScanMockGetString) Return(s1 string, err error) *ScanMock {
	...
	mmGetString.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetString *mScanMockGetString) Set(f func(fieldName string) (s1 string, err error)) *ScanMock {
	...
	mmGetString.mock.funcGetStringOrigin = minimock.CallerInfo(1)
	return mmGetString.mock
}
...
func (mmGetString *mScanMockGetString) When(fieldName string) *ScanMockGetStringExpectation {
	...
	expectation := &ScanMockGetStringExpectation{
		...
		expectationOrigins: ScanMockGetStringExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetString *mScanMockGetString) Times(n uint64) *mScanMockGetString {
	...
	mmGetString.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetString
}
...
func (mmGetString *ScanMock) GetString(fieldName string) (s1 string, err error) {
	...
	if mmGetString.GetStringMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fieldName != nil && !minimock.Equal(*mm_want_ptrs.fieldName, mm_got.fieldName) {
				mmGetString.t.Errorf("ScanMock.GetString got unexpected parameter fieldName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetString.GetStringMock.defaultExpectation.expectationOrigins.originFieldName, *mm_want_ptrs.fieldName, mm_got.fieldName, minimock.Diff(*mm_want_ptrs.fieldName, mm_got.fieldName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetString.t.Errorf("ScanMock.GetString got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetString.GetStringMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ScanMock) MinimockGetStringInspect() {
	for _, e := range m.GetStringMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ScanMock.GetString at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetStringMock.defaultExpectation != nil && afterGetStringCounter < 1 {
		if m.GetStringMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ScanMock.GetString at\n%s", m.GetStringMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ScanMock.GetString at\n%s with params: %#v", m.GetStringMock.defaultExpectation.expectationOrigins.origin, *m.GetStringMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetString != nil && afterGetStringCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.GetString at\n%s", m.funcGetStringOrigin)
	}

	if !m.GetStringMock.invocationsDone() && afterGetStringCounter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.GetString at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetStringMock.expectedInvocations), m.GetStringMock.expectedInvocationsOrigin, afterGetStringCounter)
	}
}
...
type ScanMockGetValExpectation struct {
	...
	expectationOrigins ScanMockGetValExpectationOrigins
...
// ScanMockGetValOrigins contains origins of expectations of the Scan.GetVal
type ScanMockGetValExpectationOrigins struct {
	origin          string
	originFieldName string
}
...
func (mmGetVal *mScanMockGetVal) Expect(fieldName string) *mScanMockGetVal {
	...
	mmGetVal.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetVal *mScanMockGetVal) ExpectFieldNameParam1(fieldName string) *mScanMockGetVal {
	...
	mmGetVal.defaultExpectation.expectationOrigins.originFieldName = minimock.CallerInfo(1)
...
func (mmGetVal *mScanMockGetVal) Return(c1 Constant, err error) *ScanMock {
	...
	mmGetVal.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetVal *mScanMockGetVal) Set(f func(fieldName string) (c1 Constant, err error)) *ScanMock {
	...
	mmGetVal.mock.funcGetValOrigin = minimock.CallerInfo(1)
	return mmGetVal.mock
}
...
func (mmGetVal *mScanMockGetVal) When(fieldName string) *ScanMockGetValExpectation {
	...
	expectation := &ScanMockGetValExpectation{
		...
		expectationOrigins: ScanMockGetValExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetVal *mScanMockGetVal) Times(n uint64) *mScanMockGetVal {
	...
	mmGetVal.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetVal
}
...
func (mmGetVal *ScanMock) GetVal(fieldName string) (c1 Constant, err error) {
	...
	if mmGetVal.GetValMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fieldName != nil && !minimock.Equal(*mm_want_ptrs.fieldName, mm_got.fieldName) {
				mmGetVal.t.Errorf("ScanMock.GetVal got unexpected parameter fieldName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetVal.GetValMock.defaultExpectation.expectationOrigins.originFieldName, *mm_want_ptrs.fieldName, mm_got.fieldName, minimock.Diff(*mm_want_ptrs.fieldName, mm_got.fieldName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetVal.t.Errorf("ScanMock.GetVal got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetVal.GetValMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ScanMock) MinimockGetValInspect() {
	for _, e := range m.GetValMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ScanMock.GetVal at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetValMock.defaultExpectation != nil && afterGetValCounter < 1 {
		if m.GetValMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ScanMock.GetVal at\n%s", m.GetValMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ScanMock.GetVal at\n%s with params: %#v", m.GetValMock.defaultExpectation.expectationOrigins.origin, *m.GetValMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetVal != nil && afterGetValCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.GetVal at\n%s", m.funcGetValOrigin)
	}

	if !m.GetValMock.invocationsDone() && afterGetValCounter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.GetVal at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetValMock.expectedInvocations), m.GetValMock.expectedInvocationsOrigin, afterGetValCounter)
	}
}
...
type ScanMockHasFieldExpectation struct {
	...
	expectationOrigins ScanMockHasFieldExpectationOrigins
...
// ScanMockHasFieldOrigins contains origins of expectations of the Scan.HasField
type ScanMockHasFieldExpectationOrigins struct {
	origin          string
	originFieldName string
}
...
func (mmHasField *mScanMockHasField) Expect(fieldName string) *mScanMockHasField {
	...
	mmHasField.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmHasField *mScanMockHasField) ExpectFieldNameParam1(fieldName string) *mScanMockHasField {
	...
	mmHasField.defaultExpectation.expectationOrigins.originFieldName = minimock.CallerInfo(1)
...
func (mmHasField *mScanMockHasField) Return(b1 bool) *ScanMock {
	...
	mmHasField.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmHasField *mScanMockHasField) Set(f func(fieldName string) (b1 bool)) *ScanMock {
	...
	mmHasField.mock.funcHasFieldOrigin = minimock.CallerInfo(1)
	return mmHasField.mock
}
...
func (mmHasField *mScanMockHasField) When(fieldName string) *ScanMockHasFieldExpectation {
	...
	expectation := &ScanMockHasFieldExpectation{
		...
		expectationOrigins: ScanMockHasFieldExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmHasField *mScanMockHasField) Times(n uint64) *mScanMockHasField {
	...
	mmHasField.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmHasField
}
...
func (mmHasField *ScanMock) HasField(fieldName string) (b1 bool) {
	...
	if mmHasField.HasFieldMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fieldName != nil && !minimock.Equal(*mm_want_ptrs.fieldName, mm_got.fieldName) {
				mmHasField.t.Errorf("ScanMock.HasField got unexpected parameter fieldName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmHasField.HasFieldMock.defaultExpectation.expectationOrigins.originFieldName, *mm_want_ptrs.fieldName, mm_got.fieldName, minimock.Diff(*mm_want_ptrs.fieldName, mm_got.fieldName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmHasField.t.Errorf("ScanMock.HasField got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmHasField.HasFieldMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ScanMock) MinimockHasFieldInspect() {
	for _, e := range m.HasFieldMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ScanMock.HasField at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.HasFieldMock.defaultExpectation != nil && afterHasFieldCounter < 1 {
		if m.HasFieldMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ScanMock.HasField at\n%s", m.HasFieldMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ScanMock.HasField at\n%s with params: %#v", m.HasFieldMock.defaultExpectation.expectationOrigins.origin, *m.HasFieldMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcHasField != nil && afterHasFieldCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.HasField at\n%s", m.funcHasFieldOrigin)
	}

	if !m.HasFieldMock.invocationsDone() && afterHasFieldCounter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.HasField at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.HasFieldMock.expectedInvocations), m.HasFieldMock.expectedInvocationsOrigin, afterHasFieldCounter)
	}
}
...
func (m *ScanMock) MinimockNextInspect() {
	...
	if m.NextMock.defaultExpectation != nil && afterNextCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.Next at\n%s", m.NextMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.NextMock.invocationsDone() && afterNextCounter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.Next at\n%s but found %d calls",
...
func (mmSchema *mScanMockSchema) Return(s1 records.Schema) *ScanMock {
	...
	mmSchema.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmSchema *mScanMockSchema) Set(f func() (s1 records.Schema)) *ScanMock {
	...
	mmSchema.mock.funcSchemaOrigin = minimock.CallerInfo(1)
	return mmSchema.mock
}
...
func (mmSchema *mScanMockSchema) Times(n uint64) *mScanMockSchema {
	...
	mmSchema.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmSchema
}
...
func (m *ScanMock) MinimockSchemaInspect() {
	...
	if m.SchemaMock.defaultExpectation != nil && afterSchemaCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.Schema at\n%s", m.SchemaMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	if m.funcSchema != nil && afterSchemaCounter < 1 {
		m.t.Errorf("Expected call to ScanMock.Schema at\n%s", m.funcSchemaOrigin)
	}

	if !m.SchemaMock.invocationsDone() && afterSchemaCounter > 0 {
		m.t.Errorf("Expected %d calls to ScanMock.Schema at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.SchemaMock.expectedInvocations), m.SchemaMock.expectedInvocationsOrigin, afterSchemaCounter)
	}
}
